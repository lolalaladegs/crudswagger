...
import com.boot.spring.crud.user.controller.UserController;
...
public class UserControllerTest {
    ...
    @Test
    void getUserByIdTest_whenSuccessful_thenReturn200OKStatus() throws  Exception {
    ...
    void addUserTest_whenSuccessful_thenReturn201CreatedStatus() throws  Exception {
        ...
        willDoNothing().given(userService).addUser(user);
